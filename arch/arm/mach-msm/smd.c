...
/*ZTE: modified by tengfei for open more debug info, 2013.12.9,begin*/
/*
int msm_smd_debug_mask = MSM_SMD_POWER_INFO | MSM_SMD_INFO |
							MSM_SMSM_POWER_INFO;
*/
int msm_smd_debug_mask = 0xff;
/*ZTE: modified by tengfei for open more debug info, 2013.12.9,end*/
