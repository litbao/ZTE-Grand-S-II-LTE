...
/*++ ZTE: modify by cuijian for pulling up the debug rx pin 20140312 ++*/
...
static struct gpiomux_setting gpio_gpio_config = {
	.func = GPIOMUX_FUNC_GPIO,
	.drv = GPIOMUX_DRV_2MA,
	.pull = GPIOMUX_PULL_NONE,
};

static struct gpiomux_setting gpio_gpio_susp_config = {
	.func = GPIOMUX_FUNC_GPIO,
	.drv = GPIOMUX_DRV_2MA,
	.pull = GPIOMUX_PULL_NONE,
};
...
/* ZTE_MODIFY by lvrongguo begin delete for es325 reset */
#if 0
...
static struct gpiomux_setting usb_sel_config0 = {
	.func = GPIOMUX_FUNC_GPIO,
	.drv = GPIOMUX_DRV_2MA,
	.pull = GPIOMUX_PULL_DOWN,
	.dir = GPIOMUX_OUT_LOW,
...
static struct gpiomux_setting usb_sel_config1 = {
	.func = GPIOMUX_FUNC_GPIO,
	.drv = GPIOMUX_DRV_2MA,
	.pull = GPIOMUX_PULL_DOWN,
	.dir = GPIOMUX_OUT_LOW,
...
/* ZTE_MODIFY by lvrongguo begin add for es325 reset/wakeup */	
static struct gpiomux_setting es325_pin = {
	.func = GPIOMUX_FUNC_GPIO,
	.drv = GPIOMUX_DRV_6MA,
	.pull = GPIOMUX_PULL_NONE,
	.dir = GPIOMUX_OUT_HIGH,
...
static struct gpiomux_setting es325_uart_pin = {
	.func = GPIOMUX_FUNC_2,
	.drv = GPIOMUX_DRV_6MA,
	.pull = GPIOMUX_PULL_NONE,
};
...
static struct gpiomux_setting es325_int_pin = {
	.func = GPIOMUX_FUNC_GPIO,
	.drv = GPIOMUX_DRV_6MA,
	.pull = GPIOMUX_PULL_NONE,
};
...
/* ZTE_MODIFY cuilinwei modify for nfc 20130628*/
static struct gpiomux_setting nfc_general_gpio = {
	.func = GPIOMUX_FUNC_GPIO,
	.drv = GPIOMUX_DRV_2MA,
	.pull = GPIOMUX_PULL_DOWN,
	.dir = GPIOMUX_OUT_LOW,
};
/* ZTE_MODIFY end by cuilinwei*/
...
static struct msm_gpiomux_config msm_blsp_configs[] __initdata = {
#if defined(CONFIG_KS8851) || defined(CONFIG_KS8851_MODULE)
	{
		...
		.settings = {
			[GPIOMUX_ACTIVE] = &gpio_gpio_config,
			[GPIOMUX_SUSPENDED] = &gpio_gpio_susp_config,
		},
	},
	{
...
#endif
	/* default usb sel to 00 and connect to MSM8974 -- */
	{
		.gpio      = 9,		/* BLSP1 QUP SPI_CS2A_N */
		.settings = {
			[GPIOMUX_SUSPENDED] = &usb_sel_config0,
		},
	},
	{
		.gpio      = 8,		/* BLSP1 QUP SPI_CS1_N */
		.settings = {
			[GPIOMUX_SUSPENDED] = &usb_sel_config1,
		},
	},
	/* default usb sel to 00 and connect to MSM8974 --   */
...
#endif	
/** ZTE_MODIFY end **/
/* ZTE_MODIFY for nfc 20130628*/

//#ifdef  CONFIG_PN544_NFC
       {     .gpio      = 26,
              .settings  = {
			  	[GPIOMUX_ACTIVE]       = &nfc_general_gpio,
              	[GPIOMUX_SUSPENDED]       = &nfc_general_gpio,
              },
       },
       {     .gpio      = 27,
              .settings  = {
...
/* ZTE_MODIFY by lvrongguo begin delete for es325 reset/wakeup */
#if 0			
	{
...
static struct gpiomux_setting wifi_module_vid_settings = {
		.func = GPIOMUX_FUNC_GPIO,
		.drv = GPIOMUX_DRV_2MA,
		.pull = GPIOMUX_PULL_UP,
	};
...
static struct msm_gpiomux_config msm_sensor_configs_dragonboard[] __initdata = {
	...
	},
	{
		...
		#else
		.settings = {
			[GPIOMUX_ACTIVE]    = &wifi_module_vid_settings,
			[GPIOMUX_SUSPENDED] = &gpio_suspend_config[1],
		},
		#endif
		/** ZTE_MODIFY wangzhanmeng add wifi module vid function   end */
...
/* ZTE_MODIFY by lvrongguo begin add for es325 reset/wakeup */
#ifdef CONFIG_SND_SOC_ES325_UART
	{
		.gpio	= 53,		/* ES325 wakeup */
		.settings = {
		    [GPIOMUX_ACTIVE] = &es325_uart_pin,
			[GPIOMUX_SUSPENDED] = &es325_uart_pin,
		},
	},
	{
		.gpio	= 54,		/* ES325 wakeup */
		.settings = {
		    [GPIOMUX_ACTIVE] = &es325_uart_pin,
			[GPIOMUX_SUSPENDED] = &es325_uart_pin,
		},
...
#else
	{
		.gpio	= 53,		/* ES325 wakeup */
		.settings = {
		    [GPIOMUX_ACTIVE] = &es325_pin,
			[GPIOMUX_SUSPENDED] = &es325_pin,
		},
	},
#endif	
	{
	...
	{
		.gpio	= 144,		/* ES325 reset */
		.settings = {
			[GPIOMUX_ACTIVE] = &es325_int_pin,
			[GPIOMUX_SUSPENDED] = &es325_int_pin,
...
static struct msm_gpiomux_config apq8074_dragonboard_ts_config[] __initdata = {
	{
		...
		.gpio      = 2,
		.settings = {
			[GPIOMUX_SUSPENDED] = &gpio_gpio_config,
		},
	},
	{
		/* BLSP1 QUP I2C_CLK */
