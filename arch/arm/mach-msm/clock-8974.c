...
static struct clk_freq_tbl ftbl_gcc_blsp1_2_uart1_6_apps_clk[] = {
	...
	F(16384000,  gpll0,    15, 256,   625),//add by wangtao for es325
	F(19200000,    cxo,    1,   0,      0),
	F(24000000,  gpll0,    5,   1,      5),
	F(32000000,  gpll0,    1,   4,     75),
	F(32768000,  gpll0,    1,   512, 9375),//add by wangtao for es325
...
static struct clk_lookup msm_clocks_8974_common[] __initdata = {
	...
	/*ZTE_MODIFY add blsp2 uart2 for communicating with es325 by wangtao,2013.12.12*/	
	CLK_LOOKUP("iface_clk", gcc_blsp2_ahb_clk.c, "f9960000.uart"),
	/*ZTE_MODIFY wangtao end*/
	...
	/*ZTE_MODIFY add blsp2 uart2 for communicating with es325b by wangtao,2013.12.12*/
	CLK_LOOKUP("core_clk", gcc_blsp2_uart4_apps_clk.c, "f9960000.uart"),
	/*ZTE_MODIFY wangtao end*/
	CLK_LOOKUP("core_clk", gcc_blsp2_uart5_apps_clk.c, ""),
	/*ZTE_MODIFY cuilinwei add for NFC 2013/07/23 */
	...
	#endif
	/*ZTE_MODIFY  end by cuilinwei for NFC*/
