...
.field private static ZTE_LCD_MODE:I = 0x0

.field private static mGloveMode:I = 0x0

.field private static final sGloveModeSwitchPath:Ljava/lang/String; = "/proc/gloved_finger_switch"
...
.field private mLcdMode:Lcom/android/server/LightsService$Light;
...
.field private mProximityScreenOfftag:Z
...
.method static constructor <clinit>()V
    ...
    .line 194
    sput v0, Lcom/android/server/power/PowerManagerService;->ZTE_LCD_MODE:I

    .line 198
    sput v0, Lcom/android/server/power/PowerManagerService;->mGloveMode:I
...
.method static synthetic access$2700(Lcom/android/server/power/PowerManagerService;)Lcom/android/server/power/PowerManagerService$PowerManagerHandler;
    .locals 1
    .param p0, "x0"    # Lcom/android/server/power/PowerManagerService;
...
.method static synthetic access$2800(Lcom/android/server/power/PowerManagerService;)Lcom/android/server/display/DisplayManagerService;
    .locals 1
    .param p0, "x0"    # Lcom/android/server/power/PowerManagerService;
...
.method private checkIfBootAnimationFinished()V
    ...
    .line 2125
    .end local v0    # "bootanimVal":I
    :goto_1
    return-void

    .line 2112
    .restart local v0    # "bootanimVal":I
    :cond_1
...
.method private goToSleepNoUpdateLocked(JI)Z
    ...
    invoke-virtual {v9, v10}, Lcom/android/server/power/DisplayPowerController;->setButtonBrightness(I)V
    ...
    invoke-virtual {v9, p3}, Lcom/android/server/power/DisplayPowerController;->setGoToSleepReason(I)V
    ...
    const-string v10, "Going to sleep due to proximity..."
...
.method private handleWakeLockDeath(Lcom/android/server/power/PowerManagerService$WakeLock;)V
    ...
    iget-wide v7, p1, Lcom/android/server/power/PowerManagerService$WakeLock;->mActiveSince:J
    ...
    const-string v6, "handleWakeLockDeath: lock="
    ...
    invoke-static {v6}, Llibcore/util/Objects;->hashCode(Ljava/lang/Object;)I
...
.method private isBeingKeptAwakeLocked()Z
    ...
    const-string v2, "isBeingKeptAwakeLocked: mStayOn="
...
.method private releaseWakeLockInternal(Landroid/os/IBinder;I)V
    ...
    const-string v7, "releaseWakeLockInternal: lock="
    ...
    const-string v7, " [not found], flags=0x"
    ...
    iget-wide v8, v3, Lcom/android/server/power/PowerManagerService$WakeLock;->mActiveSince:J
    ...
    invoke-interface {v4, v3, v6}, Landroid/os/IBinder;->unlinkToDeath(Landroid/os/IBinder$DeathRecipient;I)Z
...
.method private updateDisplayPowerStateLocked(I)V
    ...
    iput v3, v7, Lcom/android/server/power/DisplayPowerRequest;->screenState:I
    ...
    const-string v10, "screen_effect_mode"
    ...
    .line 1892
    :goto_2
    sget v7, Lcom/android/server/power/PowerManagerService;->ZTE_LCD_MODE:I

    if-eq v7, v6, :cond_2

    .line 1893
    sput v6, Lcom/android/server/power/PowerManagerService;->ZTE_LCD_MODE:I

    .line 1894
    sget v7, Lcom/android/server/power/PowerManagerService;->ZTE_LCD_MODE:I

    invoke-virtual {p0, v7}, Lcom/android/server/power/PowerManagerService;->setZteLcdModeInternal(I)V
    ...
    iput v5, v7, Lcom/android/server/power/DisplayPowerRequest;->screenBrightness:I
    ...
    iget-boolean v10, p0, Lcom/android/server/power/PowerManagerService;->mProximityScreenOfftag:Z
    ...
    .line 1939
    .local v2, "gloveMode":I
    sget v7, Lcom/android/server/power/PowerManagerService;->mGloveMode:I

    if-eq v7, v2, :cond_6

    .line 1940
    sput v2, Lcom/android/server/power/PowerManagerService;->mGloveMode:I

    .line 1941
    sget v7, Lcom/android/server/power/PowerManagerService;->mGloveMode:I

    invoke-virtual {p0, v7}, Lcom/android/server/power/PowerManagerService;->setGloveMode(I)V
    ...
    .line 1888
    .restart local v6    # "selectionItem":I
    :catch_0
    move-exception v1
    ...
    const-string v10, "screen_effect_mode not found"
...
.method private updateUserActivitySummaryLocked(JI)V
    ...
    const-string v7, "sys.property.isKidsmode"
    ...
    const-string v6, "fanwx: in kismode, not turn-off screen!!"
...
.method private updateWakeLockSummaryLocked(I)V
    ...
    .line 1490
    iput-boolean v4, p0, Lcom/android/server/power/PowerManagerService;->mProximityScreenOfftag:Z
    ...
    .line 1529
    :cond_1
    iput-boolean v5, p0, Lcom/android/server/power/PowerManagerService;->mProximityScreenOfftag:Z
...
.method private userActivityNoUpdateLocked(JIII)Z
    ...
    invoke-virtual {v2, v3}, Lcom/android/server/power/DisplayPowerController;->setButtonBrightness(I)V
...
.method private wakeUpNoUpdateLocked(J)Z
    ...
    const-string v0, "service.quickboot.state"
    ...
    const-string v1, "not allow to Waking up from qucikboot shutdown..."
...
.method public getGloveMode()I
    ...
    const-string v4, "/proc/gloved_finger_switch"
    ...
    const-string v5, "can\'t open GloveMode file for read:"
...
.method public setGloveMode(I)V
    .locals 5
    .param p1, "mode"    # I
    ...
    const-string v2, "/proc/gloved_finger_switch"
    ...
    const-string v4, "can\'t open GloveMode file for write:"
...
.method public setZteLcdMode(I)V
    .locals 5
    .param p1, "mode"    # I
    ...
    .local v0, "ident":J
    :try_start_0
    invoke-virtual {p0, p1}, Lcom/android/server/power/PowerManagerService;->setZteLcdModeInternal(I)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public setZteLcdModeInternal(I)V
    .locals 3
    .param p1, "mode"    # I
    ...
    .line 2334
    :cond_0
    iget-object v0, p0, Lcom/android/server/power/PowerManagerService;->mLcdMode:Lcom/android/server/LightsService$Light;
    ...
    .line 2338
    invoke-virtual {v0, p1}, Lcom/android/server/LightsService$Light;->setZteLcdMode(I)V
...
.method public systemReady(Lcom/android/server/TwilightService;Lcom/android/server/dreams/DreamManagerService;)V
    ...
    iput-object v2, v0, Lcom/android/server/power/PowerManagerService;->mLcdMode:Lcom/android/server/LightsService$Light;
    ...
    .line 485
    sget v2, Lcom/android/server/power/PowerManagerService;->mGloveMode:I

    move-object/from16 v0, p0

    invoke-virtual {v0, v2}, Lcom/android/server/power/PowerManagerService;->setGloveMode(I)V
