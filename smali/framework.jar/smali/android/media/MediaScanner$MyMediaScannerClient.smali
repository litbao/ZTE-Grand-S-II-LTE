...
.method private convertString(Ljava/lang/String;)Ljava/lang/String;
    ...
    :try_start_0
    invoke-direct {p0, p1}, Landroid/media/MediaScanner$MyMediaScannerClient;->getEncoding(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v3

    .line 681
    .local v3, "tmpEncoding":Ljava/lang/String;
    const-string v4, ""
    ...
    .end local v0    # "destString":Ljava/lang/String;
    .local v1, "destString":Ljava/lang/String;
    move-object v0, v1

    .line 691
    .end local v1    # "destString":Ljava/lang/String;
    .end local v3    # "tmpEncoding":Ljava/lang/String;
    .restart local v0    # "destString":Ljava/lang/String;
    :goto_0
    return-object v0

    .line 684
    .restart local v3    # "tmpEncoding":Ljava/lang/String;
    :cond_0
    move-object v0, p1
    ...
    const-string v5, "destString Exception"
...
.method private endFile(Landroid/media/MediaScanner$FileEntry;ZZZZZ)Landroid/net/Uri;
    ...
    invoke-static {v4}, Landroid/media/MediaScanner;->access$600(Landroid/media/MediaScanner;)I
    ...
    # getter for: Landroid/media/MediaScanner;->mMtpObjectHandle:I
    invoke-static {v5}, Landroid/media/MediaScanner;->access$600(Landroid/media/MediaScanner;)I
    ...
    # getter for: Landroid/media/MediaScanner;->mDefaultRingtoneFilename:Ljava/lang/String;
    invoke-static {v5}, Landroid/media/MediaScanner;->access$800(Landroid/media/MediaScanner;)Ljava/lang/String;
    ...
    const-string/jumbo v8, "notification/ringtone/alarm will be set again. "
    ...
    iget-object v8, v0, Landroid/media/MediaScanner$FileEntry;->mPath:Ljava/lang/String;
...
.method private getEncoding(Ljava/lang/String;)Ljava/lang/String;
    .locals 7
    ...
    .line 670
    .end local v4    # "s3":Ljava/lang/String;
    :catch_3
    move-exception v5
...
.method private setSettingIfNotSet(Ljava/lang/String;Landroid/net/Uri;J)V
    ...
    const-string/jumbo v3, "setSettingIfNotSet existingSettingValue is "
    ...
    const-string/jumbo v3, "setSettingIfNotSet putString value = "
...
.method private toValues()Landroid/content/ContentValues;
    ...
    invoke-direct {p0, v2}, Landroid/media/MediaScanner$MyMediaScannerClient;->convertString(Ljava/lang/String;)Ljava/lang/String;
...
.method public doScanFile(Ljava/lang/String;Ljava/lang/String;JJZZZ)Landroid/net/Uri;
    ...
    invoke-direct {v0, v3, v10}, Landroid/media/MediaScanner$MyMediaScannerClient;->doesPathHaveFilename(Ljava/lang/String;Ljava/lang/String;)Z

    move-result v3

    if-eqz v3, :cond_1

    const-string/jumbo v3, "notification_set"

    move-object/from16 v0, p0

    invoke-direct {v0, v3}, Landroid/media/MediaScanner$MyMediaScannerClient;->doesSettingEmpty(Ljava/lang/String;)Z
    ...
    const-string/jumbo v3, "ringtone_set"
    ...
    const-string v10, "entry is null"
    ...
    invoke-static {v3}, Landroid/media/MediaScanner;->access$1100(Landroid/media/MediaScanner;)Ljava/lang/String;
