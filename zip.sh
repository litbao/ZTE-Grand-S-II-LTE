...
unzip -n ./out/flyme_ZTE-Grand-S-II-LTE_ya0shen9_5.1.10.17R.zip -d ./out/temp
...
echo "纯净包"
cd ./out/temp
zip -r ../full-flyme_ZTE-Grand-S-II-LTE_ya0shen9_5.1.10.17R.zip *
cd ../..
...
#cd ./out/temp
#zip -r ../B1-flyme_ZTE-Grand-S-II-LTE_ya0shen9_5.1.10.17R.zip *
#cd ../..
...
#cd ./out/temp
#zip -r ../B2-flyme_ZTE-Grand-S-II-LTE_ya0shen9_5.1.10.17R.zip *
#cd ../..
...
#cd ./out/temp
#zip -r ../A4-flyme_ZTE-Grand-S-II-LTE_ya0shen9_5.1.10.17R.zip *
#cd ../..
