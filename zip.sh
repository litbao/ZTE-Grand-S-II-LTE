...
rm -rf $OUT_DIR/temp
mkdir $OUT_DIR/temp
unzip -n $OUT_DIR/flyme_ZTE-Grand-S-II-LTE_ya0shen9_5.1.12.5R.zip -d $OUT_DIR/temp
...
cd $OUT_DIR/temp
zip -r ../A1-flyme_ZTE-Grand-S-II-LTE_ya0shen9_5.1.12.5R.zip *

elif [ -e $OUT_DIR/merged_target_files/A2 ];then
cd $OUT_DIR/temp
zip -r ../A2-flyme_ZTE-Grand-S-II-LTE_ya0shen9_5.1.12.5R.zip *

else
cd $OUT_DIR/temp
zip -r ../full-flyme_ZTE-Grand-S-II-LTE_ya0shen9_5.1.12.5R.zip *
fi
