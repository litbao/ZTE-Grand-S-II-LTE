...
.field static PerActName:Ljava/lang/String; = null

.field static PerPkgName:Ljava/lang/String; = null
...
.method static constructor <clinit>()V
    ...
    .line 187
    sput-wide v0, Lcom/android/server/am/ActivityRecord;->tmpTime:J

    .line 188
    sput-wide v0, Lcom/android/server/am/ActivityRecord;->appBeginTime:J

    .line 189
    sput-wide v0, Lcom/android/server/am/ActivityRecord;->actBeginTime:J

    .line 190
    const-string v0, ""

    sput-object v0, Lcom/android/server/am/ActivityRecord;->PerPkgName:Ljava/lang/String;

    .line 191
    const-string v0, ""

    sput-object v0, Lcom/android/server/am/ActivityRecord;->PerActName:Ljava/lang/String;

    .line 193
    const-string v0, ""

    sput-object v0, Lcom/android/server/am/ActivityRecord;->phoneVersion:Ljava/lang/String;
...
.method constructor <init>(Lcom/android/server/am/ActivityManagerService;Lcom/android/server/am/ProcessRecord;ILjava/lang/String;Landroid/content/Intent;Ljava/lang/String;Landroid/content/pm/ActivityInfo;Landroid/content/res/Configuration;Lcom/android/server/am/ActivityRecord;Ljava/lang/String;IZLcom/android/server/am/ActivityStackSupervisor;Lcom/android/server/am/ActivityStackSupervisor$ActivityContainer;Landroid/os/Bundle;)V
    ...
    const-string v6, "com.zte.android.UserUsageStatsService"
    ...
    iput-object v4, p0, Lcom/android/server/am/ActivityRecord;->blackList:[Ljava/lang/String;
    ...
    sput-object v4, Lcom/android/server/am/ActivityRecord;->phoneVersion:Ljava/lang/String;
...
.method public blackRecords(Ljava/lang/String;)Z
    .locals 2
    .param p1, "spkgName"    # Ljava/lang/String;
    ...
    .local v0, "i":I
    :goto_0
    iget-object v1, p0, Lcom/android/server/am/ActivityRecord;->blackList:[Ljava/lang/String;
...
.method public windowsVisible()V
    ...
    const-string v7, "persist.sys.ztelog.user"
    ...
    .line 1012
    const-string v5, "shujuanmei_on windowsVisible"

    new-instance v7, Ljava/lang/StringBuilder;

    invoke-direct {v7}, Ljava/lang/StringBuilder;-><init>()V

    const-string v8, "shujuanmei packageName is:"
    ...
    const-string v8, " PerPkgName is:"

    invoke-virtual {v7, v8}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v7

    sget-object v8, Lcom/android/server/am/ActivityRecord;->PerPkgName:Ljava/lang/String;

    invoke-virtual {v7, v8}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v7

    const-string v8, " PerActName is:"

    invoke-virtual {v7, v8}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v7

    sget-object v8, Lcom/android/server/am/ActivityRecord;->PerActName:Ljava/lang/String;

    invoke-virtual {v7, v8}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v7

    const-string v8, " actName = "
    ...
    sget-object v7, Lcom/android/server/am/ActivityRecord;->PerPkgName:Ljava/lang/String;
    ...
    sput-wide v8, Lcom/android/server/am/ActivityRecord;->appBeginTime:J

    .line 1018
    :cond_0
    iget-object v5, p0, Lcom/android/server/am/ActivityRecord;->packageName:Ljava/lang/String;

    invoke-virtual {p0, v5}, Lcom/android/server/am/ActivityRecord;->blackRecords(Ljava/lang/String;)Z
    ...
    .line 1024
    const-string v5, "U_S_E_R"

    new-instance v7, Ljava/lang/StringBuilder;

    invoke-direct {v7}, Ljava/lang/StringBuilder;-><init>()V

    const-string v8, "{\"value\":{\"type\":\"2\", \"PerActName\":\""
    ...
    sget-wide v8, Lcom/android/server/am/ActivityRecord;->tmpTime:J
    ...
    .line 1028
    :cond_1
    sget-object v5, Lcom/android/server/am/ActivityRecord;->PerPkgName:Ljava/lang/String;
    ...
    const-string v8, "{\"value\":{\"type\":\"1\", \"PerPkgName\":\""
    ...
    const-string v8, "\",\"appBeginTime\":\""

    invoke-virtual {v7, v8}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v7

    sget-wide v8, Lcom/android/server/am/ActivityRecord;->appBeginTime:J
    ...
    sput-object v5, Lcom/android/server/am/ActivityRecord;->PerPkgName:Ljava/lang/String;
    ...
    sput-object v5, Lcom/android/server/am/ActivityRecord;->PerActName:Ljava/lang/String;
    ...
    sput-wide v8, Lcom/android/server/am/ActivityRecord;->tmpTime:J
    ...
    const-string v7, "Timeline: Activity_windows_visible id: "
