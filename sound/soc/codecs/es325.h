...
#ifdef VOICE_SENSE
#define ES325_BOOT_ACK			0x01010101//0x0101
#else
...
#define ES325_SET_POWER_STATE		0x9010
...
#define ES325_DIGITAL_GAIN		0x20D5
/****************************for Voice Wakeup***********
#define ES325_VOICE_SENSE_ENABLE	0x8000
#define ES325_VOICE_SENSE_SET_KEYWORD	0x8000
#define ES325_VOICE_SENSE_EVENT	0x806D
#define ES325_VOICE_SENSE_TRAINING_MODE	0x007d
#define ES325_VOICE_SENSE_TRAINING_STATUS	0x8000
#define ES325_VOICE_SENSE_TRAINING_RECORD	0x007f
#define ES325_VOICE_SENSE_DEMO_ENABLE	0x8000
#define ES325_VOICE_SENSE_ABORT	0x8000
#define ES325_VOICE_SENSE_DETECTION_SENSITIVITY 0x007e

#define ES325_SET_POWER_STATE_SLEEP		0x0001
#define ES325_SET_POWER_STATE_MP_SLEEP		0x0002
#define ES325_SET_POWER_STATE_MP_CMD		0x0003
#define ES325_SET_POWER_STATE_NORMAL		0x0004
#define ES325_SET_POWER_STATE_VS_OVERLAY		0x0005
#define ES325_SET_POWER_STATE_VS_LOWPWR		0x0006
#define ES325_SBL_ACK			0x8000FFFF
***/
...
#define ES325_VS_KEYWORD_PARAM_MAX		4400//Richard change new
#define ES325_SET_POWER_STATE_NO_RSP		0x9010

#define ES325_VOICE_SENSE_ENABLE	0x8000
#define ES325_VOICE_SENSE_SET_KEYWORD	0x8000
#define ES325_VOICE_SENSE_EVENT	0x806D
#define ES325_VOICE_SENSE_TRAINING_MODE	0x007f//0x007d
#define ES325_VOICE_SENSE_TRAINING_STATUS	0x0082//Richard new
#define ES325_VOICE_SENSE_TRAINING_RECORD	0x0081//0x007f
#define ES325_VOICE_SENSE_DEMO_ENABLE	0x8000
#define ES325_VOICE_SENSE_ABORT	0x8000
#define ES325_VOICE_SENSE_DETECTION_SENSITIVITY 0x0080//0x007e
...
#define ES325_EVENT_RESPONSE	0x801A
#define ES325_VS_STORED_KEYWORD	(ES325_VOICE_SENSE_DEMO_ENABLE + 1)
...
struct es325_priv {
	...
	u16 vs_keyword_param_next_index_write;
	u16 vs_keyword_param_next_index_read;
	u8 vs_keyword_param[ES325_VS_KEYWORD_PARAM_MAX];
#ifdef CONFIG_SND_SOC_ES325_UART
	struct device *dev;
	struct es325_uart_dev uart_dev;
	int (*uart_dev_read)(struct es325_priv *es325, void *buf, int len);
	int (*uart_dev_write)(struct es325_priv *es325, const void *buf, int len);
	int (*uart_dev_write_then_read)(struct es325_priv *es325, const void *buf,
					int len, u32 *rspn, int match);

	int (*uart_boot_setup)(struct es325_priv *es325);
	int (*uart_boot_finish)(struct es325_priv *es325);
	int (*uart_cmd)(struct es325_priv *es325, u32 cmd, int sr, u32 *resp);
	int (*uart_open)(struct es325_priv *es325);
	int (*uart_close)(struct es325_priv *es325);
	int uart_state;
	u32 uart_fw_rate;
#endif
#endif
