...
#ifdef CONFIG_ZTE_AUDIENCE_WAKEUP
#define VOICE_SENSE 1
#endif
...
#ifdef VOICE_SENSE
	0x5003, /* VOICE_SENSE_TRAINING_MODE */
	0x5004, /* VOICE_SENSE_DETECTION_SENSITIVITY */
	0x5006,  /* VOICE_SENSE_TRAINING_RECORD */
	0x5007 /*ES325_VOICE_SENSE_TRAINING_STATUS*/
#endif
};
...
static struct es325_cmd_access es325_cmd_access[] = {
	...
	{ /* Set digital Gain */
		.read_msg = { 0x80, 0x1D, 0x00, 0x00 },
		.read_msg_len = 4,
		.write_msg = { 0x90, 0x15, 0x00, 0x00 },
		.write_msg_len = 4,
		.val_shift = 0,
		.val_max = 0,
	},
#ifdef VOICE_SENSE
	{ /* VOICE_SENSE_ENABLE */
		.read_msg = { 0x80, 0x00, 0x00, 0x00 },
		.read_msg_len = 4,
		.write_msg = { 0x80, 0x00, 0x00, 0x00 },
		.write_msg_len = 4,
		.val_shift = 0,
		.val_max = 1,
	},
	{ /* VOICE_SENSE_SET_KEYWORD */
		.read_msg = { 0x80, 0x17, 0x50, 0x03 },
		.read_msg_len = 4,
		.write_msg = { 0x90, 0x17, 0x50, 0x03 ,
				0x90, 0x18, 0x00, 0x00 },
		.write_msg_len = 8,
		.val_shift = 0,
		.val_max = 4,
	...
	{ /* VOICE_SENSE_TRAINING_RECORD */
		.read_msg = { 0x80, 0x17, 0x50, 0x06 },
		.read_msg_len = 4,
		.write_msg = { 0x90, 0x17, 0x50, 0x06,
				0x90, 0x18, 0x00, 0x00 },
		.write_msg_len = 8,
		.val_shift = 0,
		.val_max = 1,
	},
	{ /* VOICE_SENSE_TRAINING_STATUS */
		.read_msg = { 0x80, 0x00, 0x00, 0x00 },
		.read_msg_len = 4,
		.write_msg = { 0x80, 0x00, 0x00, 0x00 },
		.write_msg_len = 4,
