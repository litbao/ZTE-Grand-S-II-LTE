...
extern int unset_bl_level;
int splash_done_flag = 0;
/** ZTE_MODIFY end **/
...
static char r63311_ce_high[33] = {0xca,0x01,0x80,0xcd,0xc8,0xcd,0xd7,0xcd,0xd7,0x12,0x24,
								...
								0x10,0x3f,0x3f,0x00,0x00,0x10,0x10,0x3f,0x3f,0x3f,0x3f};
#else
static char r63311_ce_low[33] = {0xCA, 0x00, 0x80, 0x83, 0xA5, 0xC8, 0xD2, 0xDC, 0xDC, 0x08, 0x20, 0x80, 0xFF, 0x0A, 0x4A, 0x37,
							0xA0, 0x55, 0xF8, 0x0C, 0x0C, 0x20, 0x10, 0x3F, 0x3F, 0x00, 0x00, 0x10, 0x10, 0x3F, 0x3F, 0x3F, 0x3F };
static char r63311_ce_middle[33] ={0xCA, 0x01, 0x80, 0x96, 0xA0, 0xB4, 0xA0, 0x96, 0xA0, 0x0C, 0x0C, 0x80, 0x82, 0x0A, 0x4A, 0x37,
							0xA0, 0x55, 0xF8, 0x08, 0x0C, 0x08, 0x10, 0x20, 0x20, 0x00, 0x00, 0x10, 0x10, 0x3F, 0x3F, 0x3F, 0x3F };
static char r63311_ce_high[33] = {0xca,0x01,0x80,0xcd,0xc8,0xcd,0xd7,0xcd,0xd7,0x12,0x24,
								0x00,0x96,0x0a,0x4a,0x37,0xa0,0x00,0xff,0x0c,0x0c,0x20,
								0x10,0x3f,0x3f,0x00,0x00,0x10,0x10,0x3f,0x3f,0x3f,0x3f};
#endif
...
static char nt35596_ie_enable_cmd2[2] = {0x55,0xB2};
static char nt35596_ie_enable_cmd3[2] = {0x55,0x52};
static char nt35596_ie_enable_cmd4[2] = {0x55,0x62};
/*
static char nt35596_ie_enable_cmd5[2] = {0x55,0x43};
static char nt35596_ie_enable_cmd6[2] = {0x55,0x53};
static char nt35596_ie_enable_cmd7[2] = {0x55,0x63};
*/
static char nt35596_ie_enable_cmd8[2] = {0x55,0x02};
...
static struct dsi_cmd_desc ys_panel_ce_off[] = {
	...
	{{DTYPE_DCS_WRITE1, 1, 0, 0, 0, sizeof(nt35596_ie_enable_cmd1)}, nt35596_ie_enable_cmd1},
	{{DTYPE_DCS_WRITE1, 1, 0, 0, 0, sizeof(nt35596_ie_enable_cmd8)}, nt35596_ie_enable_cmd8},
};
...
static struct dsi_cmd_desc ys_panel_ce_mid[] = {
	...
	{{DTYPE_DCS_WRITE1, 1, 0, 0, 0, sizeof(nt35596_ie_cmd02)}, nt35596_ie_cmd02},
	{{DTYPE_DCS_WRITE1, 1, 0, 0, 0, sizeof(nt35596_ie_enable_cmd1)}, nt35596_ie_enable_cmd1},
	{{DTYPE_DCS_WRITE1, 1, 0, 0, 0, sizeof(nt35596_ie_enable_cmd3)}, nt35596_ie_enable_cmd3},
};
static struct dsi_cmd_desc ys_panel_ce_high[] = {
	...
	{{DTYPE_DCS_WRITE1, 1, 0, 0, 0, sizeof(nt35596_ie_cmd02)}, nt35596_ie_cmd02},
	{{DTYPE_DCS_WRITE1, 1, 0, 0, 0, sizeof(nt35596_ie_enable_cmd1)}, nt35596_ie_enable_cmd1},
	{{DTYPE_DCS_WRITE1, 1, 0, 0, 0, sizeof(nt35596_ie_enable_cmd4)}, nt35596_ie_enable_cmd4},
};
...
int panel_ce_set(int mode)
{
	...
	if(splash_done_flag == 0)
	{
		pr_info("panel_ce_set failed, splash_done_flag = 0\n");
		return 0;
	}
	...
	{		
		if (isyassy | istianma)
		{
			...
			cmdreq.cmds = ys_panel_ce_off;
			cmdreq.cmds_cnt = ARRAY_SIZE(ys_panel_ce_off);
	...
	else if(mode == lcd_ce_LOW)
	{
		if (isyassy | istianma)
		{
			...
			cmdreq.cmds = ys_panel_ce_low;
			cmdreq.cmds_cnt = ARRAY_SIZE(ys_panel_ce_low);
			cmdreq.flags = CMD_REQ_COMMIT | CMD_CLK_CTRL;
			cmdreq.rlen = 0;
			cmdreq.cb = NULL;
			mdss_dsi_cmdlist_put(g_ctrl_pdata, &cmdreq);
		...
		else
		{
			...
			cmdreq.cmds = lg_pannel_ce_low;
			cmdreq.cmds_cnt = ARRAY_SIZE(lg_pannel_ce_low);
			cmdreq.flags = CMD_REQ_COMMIT | CMD_CLK_CTRL;
			cmdreq.rlen = 0;
			cmdreq.cb = NULL;
			mdss_dsi_cmdlist_put(g_ctrl_pdata, &cmdreq);
	...
	else if(mode == lcd_ce_MIDDLE)
	{
		if (isyassy | istianma)
		{
			...
			cmdreq.cmds = ys_panel_ce_mid;
			cmdreq.cmds_cnt = ARRAY_SIZE(ys_panel_ce_mid);
			cmdreq.flags = CMD_REQ_COMMIT | CMD_CLK_CTRL;
			cmdreq.rlen = 0;
			cmdreq.cb = NULL;
			mdss_dsi_cmdlist_put(g_ctrl_pdata, &cmdreq);
		...
		else
		{
			...
			cmdreq.cmds = lg_pannel_ce_middle;
			cmdreq.cmds_cnt = ARRAY_SIZE(lg_pannel_ce_middle);
			cmdreq.flags = CMD_REQ_COMMIT | CMD_CLK_CTRL;
			cmdreq.rlen = 0;
			cmdreq.cb = NULL;
			mdss_dsi_cmdlist_put(g_ctrl_pdata, &cmdreq);
	...
	else if(mode == lcd_ce_HIGH)
	{
		if (isyassy | istianma)
		{
			...
			cmdreq.cmds = ys_panel_ce_high;
			cmdreq.cmds_cnt = ARRAY_SIZE(ys_panel_ce_high);
			cmdreq.flags = CMD_REQ_COMMIT | CMD_CLK_CTRL;
			cmdreq.rlen = 0;
			cmdreq.cb = NULL;
			mdss_dsi_cmdlist_put(g_ctrl_pdata, &cmdreq);
		...
		else
		{
			...
			cmdreq.cmds = lg_pannel_ce_high;
			cmdreq.cmds_cnt = ARRAY_SIZE(lg_pannel_ce_high);
			cmdreq.flags = CMD_REQ_COMMIT | CMD_CLK_CTRL;
			cmdreq.rlen = 0;
			cmdreq.cb = NULL;
			mdss_dsi_cmdlist_put(g_ctrl_pdata, &cmdreq);
				...
				struct mdss_dsi_ctrl_pdata *ctrl_pdata)
{
	...
	/** ZTE_MODIFY niugang10089953 modify for lcd **/
