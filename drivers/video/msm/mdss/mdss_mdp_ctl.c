...
#else
#define MDSS_MDP_BUS_FUDGE_FACTOR_IB(val) (((val) / 2) * 3 * 5 / 4)
#define MDSS_MDP_BUS_FUDGE_FACTOR_HIGH_IB(val) ((val << 1) * 5 / 4)
#define MDSS_MDP_BUS_FUDGE_FACTOR_AB(val) ((val << 1) * 5 / 4)
#define MDSS_MDP_BUS_FLOOR_BW ((3200000000ULL >> MDSS_MDP_BUS_FACTOR_SHIFT) * 5 / 4)
#endif
/** ZTE_MODIFY niugang10089953 modify for mdp underrun **/
#if 1
/* 1.25 clock fudge factor */
#define MDSS_MDP_CLK_FUDGE_FACTOR(val) (((val) * 5) / 4)
#else
/* 1.5 clock fudge factor */
#define MDSS_MDP_CLK_FUDGE_FACTOR(val) (((val) * 3) / 2)
#endif
/** ZTE_MODIFY end **/
enum {
