...
.method public constructor <init>()V
    ...
    .line 19
    iput v0, p0, Lcom/android/internal/telephony/simcap;->ext1length:I
...
.method public writeToParcel(Landroid/os/Parcel;I)V
    ...
    .line 49
    iget v0, p0, Lcom/android/internal/telephony/simcap;->numberlength:I

    invoke-virtual {p1, v0}, Landroid/os/Parcel;->writeInt(I)V

    .line 50
    iget v0, p0, Lcom/android/internal/telephony/simcap;->emaillength:I

    invoke-virtual {p1, v0}, Landroid/os/Parcel;->writeInt(I)V

    .line 51
    iget v0, p0, Lcom/android/internal/telephony/simcap;->anrlength:I

    invoke-virtual {p1, v0}, Landroid/os/Parcel;->writeInt(I)V

    .line 52
    iget v0, p0, Lcom/android/internal/telephony/simcap;->ext1length:I

    invoke-virtual {p1, v0}, Landroid/os/Parcel;->writeInt(I)V

    .line 53
    iget v0, p0, Lcom/android/internal/telephony/simcap;->ext1Size:I

    invoke-virtual {p1, v0}, Landroid/os/Parcel;->writeInt(I)V

    .line 54
    iget v0, p0, Lcom/android/internal/telephony/simcap;->curExt1Size:I

    invoke-virtual {p1, v0}, Landroid/os/Parcel;->writeInt(I)V

    .line 55
    iget v0, p0, Lcom/android/internal/telephony/simcap;->simSize:I

    invoke-virtual {p1, v0}, Landroid/os/Parcel;->writeInt(I)V

    .line 56
    iget v0, p0, Lcom/android/internal/telephony/simcap;->curSimSize:I

    invoke-virtual {p1, v0}, Landroid/os/Parcel;->writeInt(I)V

    .line 57
    iget v0, p0, Lcom/android/internal/telephony/simcap;->usimSize:I

    invoke-virtual {p1, v0}, Landroid/os/Parcel;->writeInt(I)V

    .line 58
    iget v0, p0, Lcom/android/internal/telephony/simcap;->curUsimSize:I
