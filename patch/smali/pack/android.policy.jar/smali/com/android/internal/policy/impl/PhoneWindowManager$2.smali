...
.method public run()V
    ...
    # invokes: Lcom/android/internal/policy/impl/PhoneWindowManager;->isInQuickBootPowerOff()Z
    ...
    const-string v2, "quick boot by pressing Power button"
    ...
    iget-object v1, v1, Lcom/android/internal/policy/impl/PhoneWindowManager;->mQuickBoot:Lcom/android/internal/policy/impl/QuickBoot;

    invoke-virtual {v1}, Lcom/android/internal/policy/impl/QuickBoot;->quickBootPowerOn()V
    ...
    const-string v4, "--LONG_PRESS_POWER_GLOBAL_ACTIONS:"
